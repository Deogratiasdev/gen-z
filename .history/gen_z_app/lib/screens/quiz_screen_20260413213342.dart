  ...
  Widget _buildQuestion() {
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(
          context,
        ).textTheme.bodyLarge?.copyWith(fontSize: 17, height: 1.4),
      ),
    );
  }
...
class _OptionButton extends StatelessWidget {
  ...
  Color get _backgroundColor {
    ...
    if (isCorrect) return AppTheme.primaryGreen.withOpacity(0.15);
  ...
  Color get _textColor {
    if (!showFeedback) {
      return isSelected ? AppTheme.primaryGreen : AppTheme.textPrimary;
    }
    if (isCorrect) return AppTheme.primaryGreen;
          ...
          children: [
            ...
            Expanded(
              child: Text(
                ...
                style: Theme.of(
                  context,
                ).textTheme.bodyLarge?.copyWith(color: _textColor),
              ),
            ),
