...
// ----------------------------------------------------------------------------
// Ce fichier affiche l'historique complet des QCM passés :
// - Liste chronologique des quiz effectués
// - Pour chaque quiz : catégorie, score, pourcentage, date
// - Barre de recherche pour filtrer les résultats
// - Indicateur visuel du score (couleur selon la performance)
// - Accès aux détails complets de chaque résultat
// - Design épuré et moderne type "carte"
// ============================================================================
